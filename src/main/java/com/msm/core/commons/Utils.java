...
//            return isEmpty(value) ? O.getSupplier(defaultSupplier) : value;
//        }
//
//        public String defaultIfBlank(final String value, final Supplier<String> defaultSupplier) {
//            return isBlank(value) ? O.getSupplier(defaultSupplier) : value;
//        }
//
...
//
//            DecimalFormat formatter = new DecimalFormat(O.defaultIfNull(pattern, () -> DEFAULT_FORMAT_PATTERN));
