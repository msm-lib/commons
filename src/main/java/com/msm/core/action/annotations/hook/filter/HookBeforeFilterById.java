package com.msm.core.action.annotations.hook.filter;
...
@Documented
@Hook(action = Constants.FilterAction.FILTER_OBJECT_BY_ID, phase = HookPhase.BEFORE_EVENT)
public @interface HookBeforeFilterById {
