package com.msm.core.action.annotations.hook.system;
...
@Documented
@Hook(phase = HookPhase.AFTER_COMMIT_EVENT, resource = Constants.GENERIC_SYSTEM_OBJECT)
public @interface HookSystemAfterCommit {
    String action();
    int order() default 0;
